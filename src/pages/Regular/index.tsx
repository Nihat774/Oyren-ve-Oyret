      ...
      <div className="bg-neutral-900">
        <div className="footer-container">
          <section className="footer-page min-h-[70.3vh]">
            <p className="font-bold text-[1.7rem] pb-1">Şərtlər və Qaydalar</p>
            <p className="text-[1.12rem]">
              Şərtlər və Qaydalar “Öyrən və Öyrət” platformasına qoşulan hər bir
              istifadəçi qeyd olunan şərtləri qəbul etmiş sayılır.
              ...
              məlumatlarının təhlükəsizliyinə görə özləri cavabdehdirlər. “Öyrən
              və Öyrət” istifadəçilərin şəxsi məlumatlarını üçüncü tərəflərlə
              paylaşmama öhdəliyi daşıyır. Platformada tədris materiallarının
              istifadəsi yalnız şəxsi təhsil məqsədləri üçün nəzərdə tutulub.
